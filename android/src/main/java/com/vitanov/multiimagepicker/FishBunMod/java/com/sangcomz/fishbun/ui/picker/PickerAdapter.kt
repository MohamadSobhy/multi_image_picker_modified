...
class PickerAdapter(
    ...
    private var pickerList: MutableList<PickerListItem> = mutableListOf()
    ...
    fun setPickerList(pickerList: MutableList<PickerListItem>) {
    ...
    class ViewHolderImage(
        ...
        val tempViewForTest: ImageView = itemView.findViewById(R.id.tempViewForTest)
        ...
        fun bindData(item: PickerListItem) {
            ...
            Log.e("Image", item.imageUri.toString());
